...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $confirm = mb_strtolower($_POST['confirmDelete']);
	if($confirm == "yes") {
        if($type == "maintenance"){
            deleteMaintRecord($database,$recordID);
        }
       elseif($type == "vendor") {
        deleteVendorRecord($database,$recordID);
       }
       elseif($type == "vehicle") {
        deleteAssetRecord($database,$recordID);
       }
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="title text-center pb-5">
                    <h2 class="font-weight-600 m-0">Confirm Delete</h2>
                ...
                <div class="title text-center pb-5">
                    <form class="getin_form" method = "POST">
                        <div class="form-group">
                            <h2 class="font-weight-600 m-0">Type YES to confirm delete:</h2><br>
                            <input type="text" name="confirmDelete" value="" /><br><br>
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-pink btn-large" id="submit_btn">submit</button><br><br>
                            </div>
                            <a href="maintRecords.php" class="btn btn-pink btn-large">OOPS, take me back...</a><br><br>
                        </div>
                    </form>
                </div>
            </div>                
